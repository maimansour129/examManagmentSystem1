...
public class Teacher extends User implements Serializable {
    ...
    public Teacher(String name, String username, String password, String role,int salary) {
        ...
        for (ClassSchool i : assignedClasses) {
            if (classID == i.getClassID()) {
                for (Student j : i.getAllStudents()) {
                    ...
                    System.out.println(j.getName()+" my notify size: "+j.getNotifications().size());
                }
            }
        }
